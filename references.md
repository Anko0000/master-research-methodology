...
- **Bifactor model**
  - 因子構造の考え方および多因子モデルの理解に使用  
  - https://www.tandfonline.com/doi/full/10.1080/00273171.2012.715555

- **私たちのR：ベストプラクティスの探求**
  - R による統計解析・実装の考え方を整理する際に参照  
  - https://www.jaysong.net/RBook/quarto.html

- **クラスタリングの交差検証法**
  - クラスタ数決定手法の整理に使用  
  - https://qiita.com/ryou83480820/items/98bff5294504f9cafc07

- **混合モデルの成分数決定（Hierarchical BIC）**
  - 混合モデルにおける成分数選択手法の理論的背景の確認に使用  
  - https://www.sciencedirect.com/science/article/abs/pii/S016794731500047X
